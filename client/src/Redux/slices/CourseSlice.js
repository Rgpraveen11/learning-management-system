...
console.log(
  "First Course Lectures =",
  response.data.courses[0]?.numberOfLectures
);

console.log(
  "First Course Array Length =",
  response.data.courses[0]?.lectures?.length
);
