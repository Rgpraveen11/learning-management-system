        ...
        <HomeLayout>
            <div className="flex flex-col lg:flex-row lg:px-20 py-12">
                <div className="lg:w-1/2 w-full px-12 flex flex-col gap-7">
                 ...
                 {/* <p className="font-semibold lg:text-2xl text-xl text-yellow-400 capitalize">Number of lectures : <span className="text-xl text-blue-500">{state.lectures?.length || 0}</span></p> */}
                    {
