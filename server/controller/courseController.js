...
console.log("DB Count =", updatedCourse.numberOfLectures);
console.log("DB Lectures Length =", updatedCourse.lectures.length);
        myCache.del("courses")
        res.status(200).json({
            success: true,
...
console.log("Before push =", course.lectures.length);

course.lectures.push(lectureData);

console.log("After push =", course.lectures.length);
...
console.log("Saved lectures =", updatedCourse.lectures.length);
console.log("Saved count =", updatedCourse.numberOfLectures);
        console.log(course)
